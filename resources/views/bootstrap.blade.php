    ...
    <nav class="navbar fixed-top navbar-expand-lg bg-purple" data-bs-theme="dark">
        ...
        <div class="container py-2 px-4">
            ...
            <a href="#" class="navbar-brand mb-0 h1">
                <img class="img-fluid" src="{{Vite::asset('resources/images/logowhite.svg')}}" alt="logo" style="width: 40px;">
            </a>
    ...
    <div id="bs-icons">
        ...
        <div class="container py-5 px-4">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <img class="img-fluid" src="{{Vite::asset('resources/images/bsicons.png')}}" alt="bootstrap-icons">
                </div>
            </div>
        </div>
        ...
        <div id="bs-themes">
            ...
            <div class="container py-5 px-4">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <img class="img-fluid" src="{{Vite::asset('resources/images/bsthemes.png')}}" alt="Bootstrap Themes">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-3 mb-5">
                        <a href="" class="logo text-decoration-none">
                            <div class="d-flex">
                                <img src="{{Vite::asset('resources/images/logoblack.svg')}}" alt="" class="img-fluid" style="width: 40px;">
